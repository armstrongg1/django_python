...
class AbreFechaCaixa(models.Model):
    ...
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador', blank=True, null=True, related_name='novo_nome1')
    ...
    usuario_abertura = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_abertura', related_name='novo_nome2')
    usuario_fechamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_fechamento', blank=True, null=True,related_name='novo_nome3')
...
class ArpaTarefas(models.Model):
    ...
    codigotarefa = models.CharField(primary_key=True, max_length=100)
...
class Art(models.Model):
    art = models.CharField(primary_key=True, max_length=100)
...
class ArtNumeroReceitaOs(models.Model):
    ...
    lei_impressao = models.CharField(max_length=100, blank=True, null=True)
...
class BackupsCopias(models.Model):
    ...
    tamanho_7z = models.CharField(max_length=100)
...
class BoletosLote(models.Model):
    codigo = models.AutoField(primary_key=True)
    convenio = models.ForeignKey('ConvenioBancos', models.DO_NOTHING, db_column='convenio',related_name='boletoslote_convenio')
    datahora = models.DateTimeField(blank=True, null=True)
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario', related_name='boletoslote_usuario')
    status = models.CharField(max_length=1, blank=True, null=True)
    datahorafechamentocancelamento = models.DateTimeField(blank=True, null=True)
    usuariofechamentocancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuariofechamentocancelamento', blank=True, null=True,related_name='Boletos_usuario')
...
class BoletosLoteParcelas(models.Model):
    ...
    parcela = models.ForeignKey('Parcelas', models.DO_NOTHING, db_column='parcela', blank=True, null=True)
    datahora = models.DateTimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='boletosloteparcelas_usuario')
...
class BoletosRetornoLote(models.Model):
    ...
    datahora = models.DateTimeField(blank=True, null=True)
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='boletosretornolote_usuario')
    status = models.CharField(max_length=1, blank=True, null=True)
    datahorafechamentocancelamento = models.DateTimeField(blank=True, null=True)
...
class CabecaNotaAvulsa(models.Model):
    ...
    usuario_cancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_cancelamento', blank=True, null=True,related_name='cabecanotaavulsa_usuario_cancelamento')
...
class CabecalhoDevolucao(models.Model):
    ...
    operadorcancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operadorcancelamento', blank=True, null=True,related_name='cabecalhodevolucao_operadorcancelamento')
    motivo_cancelamento = models.ForeignKey('Motivos', models.DO_NOTHING, db_column='motivo_cancelamento', blank=True, null=True)
    complemento_cancelamento = models.CharField(max_length=100, blank=True, null=True)
    finalidade = models.IntegerField()
...
class CabecalhoEntrega(models.Model):
    ...
    status = models.CharField(max_length=1, blank=True, null=True)
    data_cancelamento = models.DateField(blank=True, null=True)
    usuario_cancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_cancelamento', blank=True, null=True,related_name='cabecalhoentrega_usuario_cancelamento')
    transportadora = models.ForeignKey('Fornecedores', models.DO_NOTHING, db_column='transportadora', blank=True, null=True)
...
class CabecalhoOrcamento(models.Model):
    ...
    nome = models.CharField(max_length=60, blank=True, null=True)
    observacao_impressa = models.ForeignKey('ObservacoesMovimentos', models.DO_NOTHING, db_column='observacao_impressa', blank=True, null=True,related_name='cabecalhoorcamento_observacao_impressa')
    ...
    usuario_cancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_cancelamento', blank=True, null=True,related_name='cabecalhoorcamento_usuario_cancelamento')
    motivo_cancelamento = models.ForeignKey('Motivos', models.DO_NOTHING, db_column='motivo_cancelamento', blank=True, null=True)
    data_cancelamento = models.DateField(blank=True, null=True)
    hora_cancelamento = models.TimeField(blank=True, null=True)
    complemento_cancelamento = models.CharField(max_length=100, blank=True, null=True)
...
class CabecalhoOrdemServico(models.Model):
    ...
    cliente = models.ForeignKey('Clientes', models.DO_NOTHING, db_column='cliente', blank=True, null=True)
    vendedor = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='vendedor', blank=True, null=True,related_name='cabecalhoordemservico_vendedor')
    ...
    transportadora = models.ForeignKey('Fornecedores', models.DO_NOTHING, db_column='transportadora', blank=True, null=True,related_name='cabecalhoordemservico_transportadora')
    ...
    observacao = models.ForeignKey('ObservacoesMovimentos', models.DO_NOTHING, db_column='observacao', blank=True, null=True)
    observacao_impressa = models.ForeignKey('ObservacoesMovimentos', models.DO_NOTHING, db_column='observacao_impressa', blank=True, null=True,related_name='cabecalhoordemservico_obaservacao_impressa')
    redespacho = models.ForeignKey('Fornecedores', models.DO_NOTHING, db_column='redespacho', blank=True, null=True)
    ...
    hora_cancelamento = models.TimeField(blank=True, null=True)
    hora_fechamento = models.TimeField(blank=True, null=True)
    usuario_cancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_cancelamento', blank=True, null=True,related_name='cabecalhoordermservico_usuario_cancelamento2')
    ...
    usuarioautorizou = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuarioautorizou', blank=True, null=True,related_name='cabecalhoordemservico_usuarioautorizou2')
...
class CabecalhoOrdemServicoLiberacaoFaturamento(models.Model):
    codigo = models.AutoField(primary_key=True)
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='cabecaolhordemservico_usuario')
    datahora = models.DateTimeField()
    usuarioautorizou = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuarioautorizou',related_name='cabecalhoordemservico_usuarioautorizou')
...
class CabecalhoRemessaVendaFora(models.Model):
    ...
    data_lancamento = models.DateField()
    hora_lancamento = models.TimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='cabremevendafora_usuario')
    vendedor = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='vendedor', blank=True, null=True)
...
class CabecalhoRetornoVendaFora(models.Model):
    ...
    data_lancamento = models.DateField()
    hora_lancamento = models.TimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='cabrevendafora_usuario')
    vendedor = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='vendedor', blank=True, null=True)
...
class CfopCstsPermitidos(models.Model):
    ...
    cst = models.CharField(max_length=100)
...
class ClienteLogAlteracoes(models.Model):
    ...
    antigo = models.CharField(max_length=100, blank=True, null=True)
    novo = models.CharField(max_length=100, blank=True, null=True)
...
class Clientes(models.Model):
    ...
    codobservacao2 = models.OneToOneField('Observacoes', models.DO_NOTHING, db_column='codobservacao2', blank=True, null=True,related_name='clientes_codobservacao2')
    ...
    prospectador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='prospectador', blank=True, null=True,related_name='clientes_prospectador')
    marca = models.CharField(max_length=1, blank=True, null=True)
    ...
    senha_md5 = models.CharField(max_length=100, blank=True, null=True)
    destino_mercadoria = models.IntegerField()
...
class ClientesDependentes(models.Model):
    codigo = models.AutoField(primary_key=True)
    cliente = models.ForeignKey(Clientes, models.DO_NOTHING, db_column='cliente', blank=True, null=True,related_name='clientesdependentes_cliente')
...
class ClientesTransportadoras(models.Model):
    cliente = models.OneToOneField(Clientes, models.DO_NOTHING, db_column='cliente', primary_key=True)
    transportadora = models.ForeignKey('Fornecedores', models.DO_NOTHING, db_column='transportadora', blank=True, null=True)
    redespacho = models.ForeignKey('Fornecedores', models.DO_NOTHING, db_column='redespacho', blank=True, null=True,related_name='clientestransportadoras_redespacho')
...
class ComposicaoMovimento(models.Model):
    ...
    item_devolucao_fornecedor = models.ForeignKey('ItensRemessa', models.DO_NOTHING, db_column='item_devolucao_fornecedor', blank=True, null=True,related_name='composicaomovimento_item_devolucao_fornecedor')
...
class DetalhesFormacaoPrecoVendaLog(models.Model):
    ...
    italico = models.BooleanField()
    sublinhado = models.BooleanField()
    nomefonte = models.CharField(max_length=100)
    tamanhofonte = models.IntegerField()
    corfonte = models.CharField(max_length=100)
    corfundo = models.CharField(max_length=100)
    atualizacusto = models.BooleanField()
    atualizavenda = models.BooleanField()
    atualizaminimo = models.BooleanField()
    observacao = models.CharField(max_length=100, blank=True, null=True)
...
class DocumentosGerenciais(models.Model):
    ...
    md5_h2 = models.CharField(max_length=100)
...
class EtiquetasSequencia(models.Model):
    ...
    desc_linha = models.CharField(max_length=100, blank=True, null=True)
    desc_coluna = models.CharField(max_length=100, blank=True, null=True)
...
class Favoritos(models.Model):
    ...
    atalho = models.CharField(max_length=100, blank=True, null=True)
...
class FiliaisTransferir(models.Model):
    origem = models.ForeignKey(Filiais, models.DO_NOTHING, db_column='origem',related_name='filiaistransferir_origem')
...
class GradeProdutosLog(models.Model):
    ...
    data = models.DateField()
    hora = models.TimeField()
    operacao = models.CharField(max_length=100, blank=True, null=True)
    desc_linha = models.CharField(max_length=100, blank=True, null=True)
    desc_coluna = models.CharField(max_length=100, blank=True, null=True)
...
class Impostos(models.Model):
    ...
    item_devolucao_fornecedor = models.OneToOneField('ItensRemessa', models.DO_NOTHING, db_column='item_devolucao_fornecedor', blank=True, null=True,related_name='impostos_item_dev_fornecdor')
...
class ImpostosIcmsSt(models.Model):
    ...
    lei = models.CharField(max_length=100, blank=True, null=True)
...
class ImpostosIss(models.Model):
    ...
    descricao_tributacao = models.CharField(max_length=100)
...
class ItensEntregaImpostos(models.Model):
    ...
    lei = models.CharField(max_length=100, blank=True, null=True)
    cst = models.CharField(max_length=100, blank=True, null=True)
...
class ItensNotaCompraImpostos(models.Model):
    ...
    ipi_cst = models.ForeignKey(CodigosFiscaisIpi, models.DO_NOTHING, db_column='ipi_cst',related_name='itensnotacompraimpostos_ipi_cst')
...
class ItensOrdemServicoExcluidos(models.Model):
    ...
    quantidade = models.DecimalField(max_digits=65535, decimal_places=65535)
    total = models.DecimalField(max_digits=65535, decimal_places=65535)
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador',related_name='itensordemservicosexcluidos_operador')
    data = models.DateTimeField()
    sequencia = models.IntegerField(blank=True, null=True)
...
class ItensRemessaVendaForaImpostos(models.Model):
    ...
    cst = models.CharField(max_length=100, blank=True, null=True)
    ipi = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    ipi_cst = models.CharField(max_length=100, blank=True, null=True)
    ipi_enquadramento = models.CharField(max_length=3, blank=True, null=True)
    pis_cst = models.CharField(max_length=3, blank=True, null=True)
    cofins_cst = models.CharField(max_length=3, blank=True, null=True)
    cofins_aliq = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class ItensRomaneioTransferido(models.Model):
    ...
    item_romaneio_destino = models.ForeignKey(ItensRomaneio, models.DO_NOTHING, db_column='item_romaneio_destino',related_name='itensrtransferido_item_romaneio_destino')
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador')
    data_hora = models.DateTimeField()
...
class LancamentoFolha(models.Model):
    ...
    funcionario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='funcionario', blank=True, null=True,related_name='lancamentofolha_funcionario')
    complemento = models.CharField(max_length=100, blank=True, null=True)
    data = models.DateField(blank=True, null=True)
...
class LctbancariosConciliacao(models.Model):
    ...
    conta = models.ForeignKey(Ctabancarias, models.DO_NOTHING, db_column='conta', blank=True, null=True)
    data = models.DateField(blank=True, null=True)
    idlancamento = models.CharField(max_length=100, blank=True, null=True)
    valor = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    descricao = models.CharField(max_length=100, blank=True, null=True)
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador')
...
class LogAlteracaoCompra(models.Model):
    ...
    valor_antigo = models.CharField(max_length=100, blank=True, null=True)
...
class LogAlteracoesPdv(models.Model):
    serie_ecf = models.CharField(max_length=100, blank=True, null=True)
...
class LogDesativacaoPdv(models.Model):
    ...
    usuariodesativacao = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuariodesativacao', blank=True, null=True,related_name='logdesativaopdv_usuariodesativacao')
...
class LogDuplicatasEmitidas(models.Model):
    ...
    usuarioexclusao = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuarioexclusao',related_name='logduplicatasemitidas_usuarioexclusao')
...
class LogInformacoesSpc(models.Model):
    ...
    data = models.DateTimeField()
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador')
    operador_reabilitacao = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador_reabilitacao', blank=True, null=True,related_name='loginformacoesspc_operador_reabilitacao')
    ...
    protocolo_desativacao = models.CharField(max_length=100)
    protocolo_ativacao = models.CharField(max_length=100)
...
class LogNotas(models.Model):
    data = models.DateField(blank=True, null=True)
    hora = models.TimeField(blank=True, null=True)
    erro = models.CharField(max_length=100, blank=True, null=True)
...
class LogOcorrencias(models.Model):
    ...
    ocorrencia = models.CharField(max_length=100)
...
class LotesMovimento(models.Model):
    ...
    produto = models.ForeignKey('Produtos', models.DO_NOTHING, db_column='produto',related_name='lotesmovimento_produto')
    item_ordem_servico = models.ForeignKey(ItensOrdemServico, models.DO_NOTHING, db_column='item_ordem_servico', blank=True, null=True)
    item_ordem_servico_despesas = models.ForeignKey(CabecalhoOrdemServicoDespesas, models.DO_NOTHING, db_column='item_ordem_servico_despesas', blank=True, null=True)
    item_orcamento = models.ForeignKey(ItensOrcamento, models.DO_NOTHING, db_column='item_orcamento', blank=True, null=True)
    item_transferencia = models.ForeignKey(ItensTransferencia, models.DO_NOTHING, db_column='item_transferencia', blank=True, null=True)
    item_transferencia_entrada = models.ForeignKey(ItensTransferenciaEntrada, models.DO_NOTHING, db_column='item_transferencia_entrada', blank=True, null=True)
    item_remessa_conserto = models.ForeignKey(ItensRemessa, models.DO_NOTHING, db_column='item_remessa_conserto', blank=True, null=True,related_name='lotesmovimento_item_remessa_conserto')
    item_remessa_conserto_entrada = models.ForeignKey(ItensRemessaEntrada, models.DO_NOTHING, db_column='item_remessa_conserto_entrada', blank=True, null=True)
    ...
    item_avulsa_entrada = models.ForeignKey(ItensNotaAvulsa, models.DO_NOTHING, db_column='item_avulsa_entrada', blank=True, null=True,related_name='lotesmovimento_item_avulsa_entrada')
    item_devolucao = models.ForeignKey(ItensDevolucao, models.DO_NOTHING, db_column='item_devolucao', blank=True, null=True)
    item_futura = models.ForeignKey(ItensEntrega, models.DO_NOTHING, db_column='item_futura', blank=True, null=True)
    item_formula = models.ForeignKey(ItensFormula, models.DO_NOTHING, db_column='item_formula', blank=True, null=True)
    item_perda = models.ForeignKey(ItensPerda, models.DO_NOTHING, db_column='item_perda', blank=True, null=True)
    ...
    item_emprestado = models.ForeignKey('ProdutosEmprestados', models.DO_NOTHING, db_column='item_emprestado', blank=True, null=True)
    item_emprestado_devolvido = models.ForeignKey('ProdutosEmprestadosDevolvidos', models.DO_NOTHING, db_column='item_emprestado_devolvido', blank=True, null=True)
    item_composicao = models.ForeignKey(ComposicaoMovimento, models.DO_NOTHING, db_column='item_composicao', blank=True, null=True,related_name='lotesmovimento_item_composicao')
    item_composicao_venda = models.ForeignKey(ComposicaoMovimento, models.DO_NOTHING, db_column='item_composicao_venda', blank=True, null=True,related_name='lotesmovimento_item_composicao_venda')
    ...
    item_lote_movimento_futura = models.ForeignKey('self', models.DO_NOTHING, db_column='item_lote_movimento_futura', blank=True, null=True,related_name='lotesmovimento_item_lote_movimento_futura')
    ...
    item_produto_entrada = models.ForeignKey('Produtos', models.DO_NOTHING, db_column='item_produto_entrada', blank=True, null=True,related_name='lotesmovimento_item_produto_entrada')
    quantidade = models.DecimalField(max_digits=65535, decimal_places=65535)
...
class MapaEcfFormasPagamento(models.Model):
    ...
    md5_a2 = models.CharField(max_length=100)
...
class Md5Dav(models.Model):
    ...
    coo = models.IntegerField(blank=True, null=True)
    codigo = models.AutoField(primary_key=True)
    numero_serie_impressora = models.CharField(max_length=100, blank=True, null=True)
    orcamento = models.ForeignKey(CabecalhoOrcamento, models.DO_NOTHING, db_column='orcamento', blank=True, null=True)
...
class MemoriaFiscalImpressa(models.Model):
    numero_serie = models.CharField(primary_key=True, max_length=100)
    data_movimento = models.CharField(max_length=100)
...
class MfePagamentos(models.Model):
    ...
    cancelado = models.BooleanField()
    id_resposta_fiscal = models.CharField(max_length=100)
...
class Notas(models.Model):
    #nota = models.AutoField(primary_key=False)
    ordem = models.IntegerField(blank=True, null=True)
    cfop = models.ForeignKey(Cfop, models.DO_NOTHING, db_column='cfop', blank=True, null=True)
    ...
    transportadora = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='transportadora', blank=True, null=True,related_name='notas_transportadora')
    ...
    redesp_transp = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='redesp_transp', blank=True, null=True,related_name='notas_redesp_transp')
    ...
    codigo = models.AutoField(primary_key=True)
    #nsu = models.AutoField(primary_key=False)
    ...
    cep = models.ForeignKey(Cidades, models.DO_NOTHING, db_column='cep', blank=True, null=True)
    cfop_transporte = models.ForeignKey(Cfop, models.DO_NOTHING, db_column='cfop_transporte', blank=True, null=True,related_name='notas_cfop_transporte')
    ...
    remessa_conserto = models.ForeignKey('Remessa', models.DO_NOTHING, db_column='remessa_conserto', blank=True, null=True,related_name='notas_remessa_conserto')
    devolucao_fornecedor = models.ForeignKey('Remessa', models.DO_NOTHING, db_column='devolucao_fornecedor', blank=True, null=True,related_name='notas_devolucao_fornecedor')
...
class NotasEletronicasRejeitadas(models.Model):
    ...
    lote = models.IntegerField()
    cfop_transporte = models.ForeignKey(Cfop, models.DO_NOTHING, db_column='cfop_transporte', blank=True, null=True,related_name='nfrejeitadas_cfop')
...
class NotasInutilizadas(models.Model):
    ...
    dhrecibo = models.CharField(max_length=100, blank=True, null=True)
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario')
    datahora = models.DateTimeField()
...
class NotasOrdenacaoItens(models.Model):
    chave_nota = models.OneToOneField(Notas, models.DO_NOTHING, db_column='chave_nota', primary_key=True)
    ordenacao = models.CharField(max_length=100, blank=True, null=True)
...
class PalmClientes(models.Model):
    ...
    email = models.CharField(max_length=50, blank=True, null=True)
    url = models.CharField(max_length=50, blank=True, null=True)
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador',related_name='palmclientes_operador')
    data = models.DateTimeField(blank=True, null=True)
...
class PalmPedidos(models.Model):
    ...
    vendedor = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='vendedor', blank=True, null=True,related_name='palmpedidos_vendedor')
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario')
...
class Parametros(models.Model):
    descricao = models.CharField(primary_key=True, max_length=100)
    valor = models.CharField(max_length=100, blank=True, null=True)
...
class PdvImpressorasNaoFiscais(models.Model):
    ...
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario')
    datahora = models.DateTimeField()
    impressora = models.CharField(max_length=100)
    changeid = models.CharField(max_length=100)
...
class PedidoCompra(models.Model):
    ...
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador',related_name='pedidocompra_operador')
    observacoes = models.ForeignKey(ObservacoesMovimentos, models.DO_NOTHING, db_column='observacoes', blank=True, null=True)
...
class PedidoCompraTransportador(models.Model):
    pedido = models.OneToOneField(PedidoCompra, models.DO_NOTHING, db_column='pedido', primary_key=True)
    transportador = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='transportador', blank=True, null=True,related_name='pedidocompratransportador_transportador')
    redespacho = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='redespacho', blank=True, null=True)
    valor = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    tipo_frete = models.IntegerField()
...
class PedidoEmitirNotaAutomatica(models.Model):
    ...
    ordem = models.ForeignKey(CabecalhoOrdemServico, models.DO_NOTHING, db_column='ordem')
    vendedor = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='vendedor')
    usersessionid = models.CharField(max_length=100)
...
class PedidosImpressos(models.Model):
    ...
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador',related_name='pedidosimpressos_operador')
    data = models.DateField()
    hora = models.TimeField()
...
class Produtos(models.Model):
    ...
    cest = models.CharField(max_length=7, blank=True, null=True)
    unidade_tributavel = models.ForeignKey('UnidadeMedidas', models.DO_NOTHING, db_column='unidade_tributavel',related_name='produtos_unidade_tributavel')
    ...
    def __str__(self):
        return f'{self.descricao} ------------- Preço Venda: {self.precovenda}'
...
class ProdutosAlteraQuantidade(models.Model):
    ...
    modulo_sistema = models.CharField(max_length=100)
...
class ProdutosComposicao(models.Model):
    produto = models.ForeignKey(Produtos, models.DO_NOTHING, db_column='produto',related_name='produtoscomposicao_produto')
    produto_item = models.ForeignKey(Produtos, models.DO_NOTHING, db_column='produto_item',related_name='produtoscomposicao_produtoitem')
    quantidade = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    codigo = models.AutoField(primary_key=True)
...
class ProdutosSimilares(models.Model):
    codigo = models.AutoField(primary_key=True)
    produto = models.ForeignKey(Produtos, models.DO_NOTHING, db_column='produto', blank=True, null=True,related_name='produtossimilares_produto')
...
class Receitas(models.Model):
    codigo = models.AutoField(primary_key=True)
    datahora = models.DateTimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='receitas_usuario')
    status = models.CharField(max_length=1)
    datahorafechamentocancelamento = models.DateTimeField(blank=True, null=True)
    usuariofechamentocancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuariofechamentocancelamento', blank=True, null=True,related_name='receitas_usuariofechamentocancelamento')
    tecnicoagricola = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='tecnicoagricola',related_name='receitas_tecnicoagraciola')
...
class ReceitasItensDetalhes(models.Model):
    ...
    utilizar = models.CharField(max_length=100)
...
class RelatorioRequisitado(models.Model):
    ...
    user_session_id = models.CharField(max_length=100)
...
class Remessa(models.Model):
    numero = models.AutoField(primary_key=True)
    data = models.DateField(blank=True, null=True)
    fornecedor = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='fornecedor', blank=True, null=True,related_name='remessa_fornecedor')
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador', blank=True, null=True,related_name='remessa_operador')
    vendedor = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='vendedor', blank=True, null=True,related_name='remessa_vendedor')
    status = models.CharField(max_length=1, blank=True, null=True)
    transportadora = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='transportadora', blank=True, null=True,related_name='remessa_transportadora')
    frete = models.DecimalField(max_digits=12, decimal_places=3)
    observacao = models.ForeignKey(ObservacoesMovimentos, models.DO_NOTHING, db_column='observacao', blank=True, null=True,related_name='remessa_observacao')
    tipo = models.CharField(max_length=1)
    ...
    data_cancelamento = models.DateTimeField(blank=True, null=True)
    usuario_cancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_cancelamento', blank=True, null=True,related_name='remessa_usario_cancelamento')
    finalidade = models.IntegerField()
    data_hora_fechamento = models.DateTimeField(blank=True, null=True)
    usuario_fechamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_fechamento', blank=True, null=True,related_name='remessa_usuario_fechamento')
...
class RemessaEntrada(models.Model):
    numero = models.AutoField(primary_key=True)
    data = models.DateField(blank=True, null=True)
    fornecedor = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='fornecedor', blank=True, null=True,related_name='remessaentrada_fornecedor')
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador', blank=True, null=True,related_name='remessaentrada_operador')
    status = models.CharField(max_length=1, blank=True, null=True)
    transportadora = models.ForeignKey(Fornecedores, models.DO_NOTHING, db_column='transportadora', blank=True, null=True)
    frete = models.DecimalField(max_digits=12, decimal_places=3, blank=True, null=True)
    observacao = models.ForeignKey(ObservacoesMovimentos, models.DO_NOTHING, db_column='observacao', blank=True, null=True,related_name='remessaentrada_observacao')
...
class Sat(models.Model):
    codigo = models.AutoField(primary_key=True)
    datahora = models.DateTimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='sat_usuario')
    numero_hd = models.CharField(max_length=8)
    ...
    usuario_desativacao = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_desativacao', blank=True, null=True,related_name='sat_usuario_desativacao')
...
class SequenciaNotas(models.Model):
    ...
    nota = models.IntegerField()
    tipo_emissao = models.CharField(max_length=100)
...
class SequenciaNotasLogAjusteNumeracao(models.Model):
    codigo = models.AutoField(primary_key=True)
    datahora = models.DateTimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='sequencianotaslogajnu_usuario')
    usuario_autorizou = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_autorizou',related_name='sequencianotaslogaju_usuario_autorizou')
    serie = models.CharField(max_length=100)
...
class Servicos(models.Model):
    ...
    status = models.CharField(max_length=1, blank=True, null=True)
    cliente = models.ForeignKey(Clientes, models.DO_NOTHING, db_column='cliente', blank=True, null=True,related_name='servicos_cliente')
    abertura = models.DateField(blank=True, null=True)
    operador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador', blank=True, null=True,related_name='servicos_operador')
    usuario_cancelamento = models.IntegerField(blank=True, null=True)
    hora_entrega = models.TimeField(blank=True, null=True)
    hora_abertura = models.TimeField(blank=True, null=True)
    obs = models.ForeignKey(ObservacoesMovimentos, models.DO_NOTHING, db_column='obs', blank=True, null=True,related_name='servicos_obs')
    servicos = models.ForeignKey(ObservacoesMovimentos, models.DO_NOTHING, db_column='servicos', blank=True, null=True,related_name='servicos_servicos')
...
class ServidorStandalone(models.Model):
    ...
    usuario_banco = models.CharField(max_length=100)
...
class Standalonelogerrosimportacao(models.Model):
    codigo = models.AutoField(primary_key=True)
    terminal = models.ForeignKey('TerminaisImportacao', models.DO_NOTHING, db_column='terminal')
    erro = models.CharField(max_length=100)
    datahora = models.DateTimeField()
...
class Standalonelogimportacao(models.Model):
    ...
    campo = models.CharField(max_length=100)
    valorantigo = models.CharField(max_length=100)
    valornovo = models.CharField(max_length=100)
    datahora = models.DateTimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario')
    terminal = models.ForeignKey('TerminaisImportacao', models.DO_NOTHING, db_column='terminal')
...
class Terminais(models.Model):
    ...
    chave_validador_sat = models.CharField(max_length=100)
    codigo_estabelecimento_tef = models.CharField(max_length=100)
...
class TerminaisDados(models.Model):
    ...
    terminal = models.ForeignKey(Terminais, models.DO_NOTHING, db_column='terminal', blank=True, null=True)
    numero_serie = models.CharField(max_length=100)
    cnpj_usuario = models.CharField(max_length=100, blank=True, null=True)
    cnpj_desenvolvedora = models.CharField(max_length=100, blank=True, null=True)
    nome_comercial = models.CharField(max_length=100, blank=True, null=True)
    md5_executavel = models.CharField(max_length=100, blank=True, null=True)
    md5 = models.CharField(max_length=100, blank=True, null=True)
    exportou = models.BooleanField()
...
class TerminalMovel(models.Model):
    codigo = models.AutoField(primary_key=True)
    datahora = models.DateTimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='terminalmovel_usuario')
    nome = models.CharField(max_length=60)
    numero_serie = models.CharField(max_length=60)
    ativo = models.BooleanField()
    motivo_desativacao = models.CharField(max_length=100)
    usuario_desativacao = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_desativacao', blank=True, null=True,related_name='terminalmovel_usuario_desativacao')
    datahora_desativacao = models.DateTimeField(blank=True, null=True)
...
class TerminalMovelNfce(models.Model):
    codigo = models.AutoField(primary_key=True)
    datahora = models.DateTimeField()
    usuario = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario',related_name='terminalmovelnfce_usuario')
    terminal = models.ForeignKey(TerminalMovel, models.DO_NOTHING, db_column='terminal',related_name='terminalmovelnfce_terminal')
    modelo = models.IntegerField()
...
class TerminalMovelSistema(models.Model):
    codigo = models.AutoField(primary_key=True)
    terminalmovel = models.ForeignKey(TerminalMovel, models.DO_NOTHING, db_column='terminalmovel',related_name='terminalmovelsistema_terminalmovel')
    data_operacao = models.DateTimeField()
    operador_registro = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='operador_registro', blank=True, null=True,related_name='terminalmovelsistema_operador_registro')
    sistema = models.IntegerField(blank=True, null=True)
    vendedor = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='vendedor',related_name='terminalmovelsistema_vendedor')
    ativo = models.BooleanField()
    motivo_desativacao = models.CharField(max_length=100)
    usuario_desativacao = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_desativacao', blank=True, null=True,related_name='terminalmovelsistema_usariodesativacao')
    datahora_desativacao = models.DateTimeField(blank=True, null=True)
...
class TmpFafNfCancelada(models.Model):
    ...
    nota_chave_nfe = models.CharField(max_length=100, blank=True, null=True)
...
class Transferencia(models.Model):
    ...
    codoperador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='codoperador', blank=True, null=True,related_name='transferencia_codoperador')
    separador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='separador', blank=True, null=True,related_name='transferecia_separador')
    ...
    criada_por = models.CharField(max_length=100, blank=True, null=True)
    data_confirmado = models.DateField(blank=True, null=True)
    hora_confirmado = models.TimeField(blank=True, null=True)
    data_cancelamento = models.DateTimeField(blank=True, null=True)
    usuario_cancelamento = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='usuario_cancelamento', blank=True, null=True,related_name='transferencia_usuario_cancelamento')
...
class TransferenciaEntrada(models.Model):
    ...
    codoperador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='codoperador', blank=True, null=True,related_name='transferenciaentrada_codoperador')
    separador = models.ForeignKey('Vendedores', models.DO_NOTHING, db_column='separador', blank=True, null=True,related_name='transferenciaentrada_separador')
    confirmado = models.CharField(max_length=3, blank=True, null=True)
    desc_cliente = models.CharField(max_length=74, blank=True, null=True)
    data_confirmado = models.DateField(blank=True, null=True)
    hora_confirmado = models.TimeField(blank=True, null=True)
...
class VendedoresConfiguracaoEnvioEmail(models.Model):
    codigo = models.AutoField(primary_key=True)
    vendedor = models.ForeignKey(Vendedores, models.DO_NOTHING, db_column='vendedor',related_name='vendedoresconfiguracaoenvioemail_vendedor')
    ...
    dataoperacao = models.DateTimeField()
    operador = models.ForeignKey(Vendedores, models.DO_NOTHING, db_column='operador',related_name='vendedoresconfiguracaoenvioemail_operador')
